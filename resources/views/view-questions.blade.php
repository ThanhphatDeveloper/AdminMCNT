                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class='col-md-12'>
                                            <form method="post" action="{{route('search-questions')}}">
                                                @csrf
                                                <div class='col-md-3'>
                                                ...
                                                <div class='col-md-3'>
                                                    <button type="submit" class='btn btn-primary btn-block' id='filter_btn'>Tìm kiếm</button>
                                                </div>
                                            </form>
                                        </div>
                                    ...
                                    <div class="pagination-block">
                                        ...
                                        {{  $list_question->appends(request()->input())->links('layouts.paginationlinks') }}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action ="{{route('update-questions')}}" >
                                ...
                                <br>
                                <div class="form-group">
                                    <label for="score" class="control-label col-md-1 col-sm-3 col-xs-12">Trạng thái</label>
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <select id="question_status" name="question_status" class="form-control" required>
                ...
                $(document).on('click','.editbtn',function() {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            $('#question_status').val(response.question.status);
                    }
                });
            });
        });
