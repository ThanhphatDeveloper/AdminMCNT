        ...
        <!-- /top navigation -->                <!-- page content -->
                <div class="right_col" role="main" aria-labelledby="mainnavheading">
                    ...
                    <div class="row">
                        <div role="main" aria-labelledby="mainnavheading">
                            <!-- top tiles -->
                            <h1 style="color:black;font-size:29px;text-align:center;">Chào mừng đến với trang quản trị một câu nữa thôi</h1>
                            <hr>
                            <div class="animated flipInY col-lg-6 col-md-3 col-sm-6 col-xs-12">
                                <div class="tile-stats">
                                    <div class="icon"><em class="fas fa-archive"></em>
                                    </div>
                            ...
                            <div class="animated flipInY col-lg-6 col-md-3 col-sm-6 col-xs-12">
                                <div class="tile-stats">
                                    ...
                                    <div class="count">{{ $countQuestion }}</div>
                                    <h3>Tổng câu đố</h3>
                                </div>
                            </div>
                            <!-- /top tiles -->
                        ...
                        <div class="animated flipInY col-lg-12 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                <div class="icon"><em class="far fa-user"></em>
                                </div>
            ...
            <footer>
                <div class="pull-right">
                    Copyright © <script type="text/javascript">document.write(new Date().getFullYear() - 1);</script>-<script type="text/javascript">document.write(new Date().getFullYear());</script> Made By Thanh Phat - Dai Nam - Huu Phuc
                </div>
                <div class="clearfix"></div>
            </footer>
            <!-- /footer content -->
