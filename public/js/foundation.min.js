                    ...
                    ? ((n = a
                      ...
                      t(this).is(":first-child")
                        ...
                        : n.children("[data-submenu]:visible").length &&
                          (n = n.find("li:last-child").find("a").first()),
                      void (
          ...
          value: function (e) {
            ...
            this.$slides.each(function () {
              (i = this.getBoundingClientRect().height),
                ...
                s && t(this).css({ position: "relative", display: "none" }),
                (n = i > n ? i : n),
                s++;
            }),
          ...
          value: function () {
            ...
            if (
              ...
              !(function () {
                ...
                (n = e),
                  e.options.overlay &&
                    Foundation.Motion.animateIn(e.$overlay, "fade-in"),
                  Foundation.Motion.animateIn(
                    e.$element,
                    e.options.animationIn,
                    function () {
                      (e.focusableElements = Foundation.Keyboard.findFocusable(
                        e.$element
                      )),
                        t();
                    }
              ...
              this.$element.on("keydown.zf.reveal", function (i) {
                ...
                Foundation.Keyboard.handleKey(i, "Reveal", {
                  tab_forward: function () {
                    return e.$element
                      .find(":focus")
                      .is(e.focusableElements.eq(-1))
                      ? (e.focusableElements.eq(0).focus(), !0)
                      : 0 === e.focusableElements.length
                      ? !0
                      : void 0;
                  },
                  tab_backward: function () {
                    return e.$element
                      .find(":focus")
                      .is(e.focusableElements.eq(0)) || e.$element.is(":focus")
                      ? (e.focusableElements.eq(-1).focus(), !0)
                      : 0 === e.focusableElements.length
                      ? !0
                      : void 0;
                  },
          ...
          value: function (n, s, o) {
            ...
            if (o) (a = this._adjustValue(null, o)), (r = !0);
              ...
              var l = this,
                ...
                c = u ? n.pageY : n.pageX,
                f =
                  (this.$handle[0].getBoundingClientRect()[d] / 2,
